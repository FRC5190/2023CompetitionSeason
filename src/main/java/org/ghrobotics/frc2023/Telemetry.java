...
public class Telemetry {
  ...
  public Telemetry(Drivetrain drivetrain, PoseEstimator poseEstimator, Limelight limelight,
                   SendableChooser<String> auto_selector, SendableChooser<String> auto_selector2,
                   SendableChooser<String> auto_selector3) {
